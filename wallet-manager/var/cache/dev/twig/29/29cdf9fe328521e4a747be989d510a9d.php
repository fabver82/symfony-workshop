...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/fabien/beCode/workshop-symfony-starter/wallet-manager/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
